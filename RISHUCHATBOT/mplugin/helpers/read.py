...
╔═══ ⋆ʟᴏᴠᴇ ᴡɪᴛʜ⋆ ══╗
♡ [ ꯭꯭𝐊 𝐀 𝐍 𝐇 Λ](https://t.me/Oyekanhaa) ♡
╚═════ ⋆★⋆ ═════╝
...
HELP_READ = f"""**
Cʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴs ʙᴇʟᴏᴡ ғᴏʀ ᴍᴏʀᴇ ɪɴғᴏʀᴍᴀᴛɪᴏɴ.  Iғ ʏᴏᴜ'ʀᴇ ғᴀᴄɪɴɢ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ ʏᴏᴜ ᴄᴀɴ ᴀsᴋ ɪɴ [sᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ](https://Aboutkanha).
